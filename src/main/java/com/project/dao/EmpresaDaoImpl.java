...
public class EmpresaDaoImpl implements EmpresaDao {
	...
	public boolean create(Empresa empresa) {
		...
		try {
			...
			flag = false;
			sesion.getTransaction().rollback();
			System.out.println("ERRORRRRR CREATE EMPRESA: "
	...
	public boolean update(Empresa empresa) {
		...
		try {
			...
			empresadb.setEmpNombre(empresa.getEmpNombre());
			empresadb.setEmpDirecc(empresa.getEmpDirecc());
			empresadb.setEmpTelf(empresa.getEmpTelf());
			empresadb.setEmpLogo(empresa.getEmpLogo());
			// fin de parametros
