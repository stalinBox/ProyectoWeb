...
public class ReflectionColumnModelBuilder {
	...
	private static Set<String> defaultExcludedProperties = new HashSet<String>(
			0);
	...
	public ReflectionColumnModelBuilder setPropertySortComparator(
			Comparator<PropertyDescriptor> c) {
	...
	public List<ColumnModel> build() {
		...
		List<PropertyDescriptor> propertyDescriptors = new ArrayList<PropertyDescriptor>(
				Arrays.asList(PropertyUtils.getPropertyDescriptors(modelClass)));

		CollectionUtils.filter(propertyDescriptors, PredicateUtils
				.andPredicate(propertyFilterPredicate, new Predicate() {
					...
					public boolean evaluate(Object object) {
						...
						propertyDescriptor.getReadMethod() != null
								...
								!excludedProperties.contains(propertyDescriptor
										.getName());
		...
		for (PropertyDescriptor propertyDescriptor : propertyDescriptors) {
			...
			columnDescriptor.setHeader(StringUtils.capitalize(StringUtils.join(
					StringUtils
							.splitByCharacterTypeCamelCase(propertyDescriptor
									.getName()), " ")));
