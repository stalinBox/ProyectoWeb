...
NOMLUGAR VARCHAR(20) UNIQUE NOT NULL
);
...
PROGRAM_CODIGO SERIAL PRIMARY KEY NOT NULL,
...
F_FINAL DATE,
HORA DATE,
ESTADO_TUR VARCHAR(10) DEFAULT 'PENDIENTE'
);
...
/* ******************** */ 
/* Insercion de datos en las tablas de calzado */
