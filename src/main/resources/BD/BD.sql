...
CAP_CODIGO SERIAL PRIMARY KEY NOT NULL,
DISTRIB_CODIGO INTEGER,
...
ALTER TABLE LINEASTURNOS ADD
FOREIGN KEY (CAP_CODIGO) REFERENCES CAPACIDADES(CAP_CODIGO) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE CAPACIDADES ADD
FOREIGN KEY (DISTRIB_CODIGO) REFERENCES DISTRIBDETALLE(DISTRIB_CODIGO) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE CAPACIDADES ADD
FOREIGN KEY (ORDENPROD_CODIGO) REFERENCES ORDENPROD(ORDENPROD_CODIGO) ON UPDATE CASCADE ON DELETE CASCADE;
